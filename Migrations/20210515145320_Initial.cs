        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodeSkills = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameSkills = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TypeSkillsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
