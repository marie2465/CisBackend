...
namespace Cis_part2.Migrations
{
    ...
    [Migration("20210526180830_Teams")]
    partial class Teams
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cis_part2.Models.PeopleInTeams", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cis_part2.Models.Teams", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cis_part2.Models.PeopleInTeams", b =>
                {
                    b.HasOne("Cis_part2.Models.Person", "Person")
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cis_part2.Models.Teams", "Teams")
                        .WithMany("PeopleInTeams")
